...
public record AlertData(
    ...
    public static final AlertData DEFAULT = new AlertData(IDLE, Map.of(), Map.of(), Optional.empty(), 0, 0);

    public AlertData withState(int newState, int ticks) {
        return new AlertData(newState, this.targetProgress, this.targetStates, this.lastSeenPos, this.reactionTicks, ticks);
    }
