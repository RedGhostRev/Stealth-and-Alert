# Entity Configuration Guide / 实体配置指南
...
### 2. 模组开发者预设路径
如果你是其他模组的开发者，希望为自己的生物提供默认的警觉配置，只需将 JSON 文件打包进你的模组 JAR 包：
...
| `assassination.success_chance` | Boolean | 刺杀成功率，仅当全局配置中的刺杀必定成功被关闭后才起作用 |
